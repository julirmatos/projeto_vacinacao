    ...
    if (empty($email) || empty($senha)) {
        ...
        try {
            ...
            if ($stmt->rowCount() === 1) {
                ...
                // Verifica se é administrador e senha correta
                if ($usuario['tipo'] === 'admin' && $senha === $usuario['senha']) {
                    // Cria sessão
                    ...
                    header("Location: ../../views/administradores/menu_admin.php");
                    exit;
                } else {
                    $erro = "Acesso negado. Verifique o tipo de usuário e a senha.";
                }
            } else {
...
<head>
    ...
    <title>Login do Administrador - Sistema de Vacinação</title>
    <style>
        * {
